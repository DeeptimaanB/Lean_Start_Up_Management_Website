...
if(isset($_POST['email']))
{
  ...
  if($row!==false)
  {
    ...
    $message = "Click on the link to reset password. http://localhost/lsm/resetPassword.php?x=".$hash;
...
<body>
    ...
    elseif($msg!="" && $msg!="1" && $msg!="2")
    {
      echo("<div class=\"jumbotron\">");
    	echo("<h1 style=\"text-align:center;\">Hartisans Welcomes You!!!</h1>");
    	echo("<p style=\"text-align:center;\"><i>\"You know it when your place smiles back at you.\"</i></p>");
    	echo("</div>");
